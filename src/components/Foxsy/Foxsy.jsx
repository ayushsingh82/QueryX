    ...
    <div className="min-h-screen bg-black p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 right-[15%] w-[500px] h-[500px] rounded-full 
          bg-gradient-radial from-pink-500/10 via-transparent to-transparent blur-3xl" />
        <div className="absolute bottom-1/4 left-[15%] w-[500px] h-[500px] rounded-full 
          bg-gradient-radial from-rose-500/10 via-transparent to-transparent blur-3xl" />
      </div>

      <div className="max-w-4xl mx-auto relative">
        {/* Header */}
        <div className="flex flex-col items-center gap-4 mb-12 mt-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-pink-400 to-rose-400 
        ...
        {/* Chat Container */}
        <div className="bg-black/40 border-2 border-pink-500/30 rounded-2xl p-6 h-[600px] 
          flex flex-col backdrop-blur-sm relative shadow-[inset_0_0_30px_rgba(236,72,153,0.1),_0_0_20px_rgba(236,72,153,0.15)]">
          {/* Messages */}
            ...
            {messages.map((message, index) => (
              ...
              >
                <div className={`max-w-[80%] rounded-2xl px-4 py-2 shadow-lg ${
                  message.role === 'user' 
                    ? 'bg-pink-500/20 text-pink-200 shadow-pink-500/10' 
          ...
          <form onSubmit={handleSubmit} className="relative">
            <input
              ...
              placeholder="Ask me anything about Foxsy..."
              className="w-full bg-black/40 border border-pink-500/20 rounded-xl py-4 px-6 pr-16
                text-gray-200 placeholder-gray-500 focus:outline-none focus:border-pink-500/50
        ...
        {/* Footer */}
        <footer className="border-t border-pink-500/20 pt-8 mt-16">
          <div className="max-w-4xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div>
                <h3 className="text-white font-semibold mb-4">About</h3>
                <p className="text-gray-400 text-sm">
                  Foxsy AI Assistant provides intelligent responses to your queries about 
                  the Foxsy protocol using advanced language models.
                </p>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="https://foxsy.io" target="_blank" rel="noopener noreferrer" 
                      className="text-gray-400 hover:text-pink-400 text-sm">Foxsy Website</a>
                  </li>
                  <li>
                    <a href="https://docs.foxsy.io" target="_blank" rel="noopener noreferrer" 
                      className="text-gray-400 hover:text-pink-400 text-sm">Documentation</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="flex gap-4">
                  <a href="https://twitter.com/FoxsyIO" target="_blank" rel="noopener noreferrer" 
                    className="text-gray-400 hover:text-pink-400">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                    </svg>
                  </a>
                  <a href="https://t.me/FoxsyIO" target="_blank" rel="noopener noreferrer" 
                    className="text-gray-400 hover:text-pink-400">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
